...
public class ImportConfigProperties {
    ...
    @NotNull
    private final ImportPathProperties path;
    ...
    public ImportPathProperties getPath() {
        return path;
    }
    ...
    @SuppressWarnings("unused")
    public static class ImportPathProperties {
        @NotNull
        @Size(min = 1)
        private String operator;

        public ImportPathProperties(String operator) {
