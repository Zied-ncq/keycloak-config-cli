...
@TestPropertySource(properties = {
        ...
        "import.force=true",
        "import.path.operator=./changelogs/operator",
        "import.path.core=./changelogs/core",
        "import.path.partner=./changelogs/partner",
        "import.state=false",
...
class ImportConfigPropertiesTest {
    ...
    void shouldPopulateConfigurationProperties() {
        assertThat(properties.getPath().getOperator(), is("./changelogs/operator"));
