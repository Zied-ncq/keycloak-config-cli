...
@TestPropertySource(properties = {
        "import.path.core=invalid",
        "import.path.operator=invalid",
        "import.path.partner=invalid"
})
class CommandLineImportNotExistsExceptionIT extends AbstractImportTest {
    ...
    void testInvalidImportException() {
        ...
        assertThat(thrown.getMessage(), is("[import.path.operator=invalid] does not exists"));
    }
}
